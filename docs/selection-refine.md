...
3. Working toolbar actions: **Cancel (✕)** / **Pin** / **Copy** (+ Esc / Return for primary).
4. On confirm → tear down overlay → capture final rect → pin or clipboard.
...
- [x] Toolbar under (or above) selection, right-aligned; Pin / Copy / Cancel work
