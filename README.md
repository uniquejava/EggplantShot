...
- **Snip** / **F1** — area select → refine (handles + Snipaste-style toolbar) → optional rectangle annotate → pin with soft glow
- **Snip and copy** / **⌘F1** — same refine UX; primary action copies to clipboard
- **Rectangle annotate** — stroke width / color sub-toolbar; draw, move, resize; baked into pin/copy/save
